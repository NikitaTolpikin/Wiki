...
namespace Wiki.Migrations
{
    ...
    [Migration("20210405074220_add_admin")]
            ...
            modelBuilder.Entity("Wiki.Комментарий", b =>
                {
                    ...
                    b.Property<DateTime>("ВремяНаписания")
                        ...
                        .HasDefaultValue(new DateTime(2021, 4, 5, 14, 42, 20, 683, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Wiki.Пользователь", b =>
                {
                    ...
                    b.HasData(
                        new { IdПользователя = new Guid("e93b7f35-c3ab-4c99-86f6-05ec93159f6a"), EMail = "admin@admin.com", ДатаРегистрации = new DateTime(2021, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ДатаРождения = new DateTime(2006, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Имя = "Admin", КодКатегории = 2L, Отчество = "Admin", Пароль = "admin", Пол = true, Фамилия = "Admin" }
                    );
                });
            ...
            modelBuilder.Entity("Wiki.Слово", b =>
                {
                    ...
                    b.HasData(
                        new { IdСлова = new Guid("05cc5f6d-df2e-4b80-8a63-704521099b04"), Название = "Тепло" },
                        new { IdСлова = new Guid("c73cb1a4-950a-43c2-b033-4e2aeb64317e"), Название = "Холодно" },
                        new { IdСлова = new Guid("3c56bffc-42a7-4685-b3f8-80939c2ff5f8"), Название = "Лес" }
                    );
                });
