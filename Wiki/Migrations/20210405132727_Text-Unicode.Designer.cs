...
namespace Wiki.Migrations
{
    ...
    [Migration("20210405132727_Text-Unicode")]
    partial class TextUnicode
    {
            ...
            modelBuilder.Entity("Wiki.Комментарий", b =>
                {
                    ...
                    b.Property<DateTime>("ВремяНаписания")
                        ...
                        .HasDefaultValue(new DateTime(2021, 4, 5, 20, 27, 27, 576, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Wiki.Слово", b =>
                {
                    ...
                    b.HasData(
                        new { IdСлова = new Guid("276c8463-3be8-48b1-ad74-4028a29f7053"), Название = "Тепло" },
                        new { IdСлова = new Guid("7f9f3deb-5e71-42c2-8a50-5803e5de8360"), Название = "Холодно" },
                        new { IdСлова = new Guid("6c9d2ea1-c739-42cc-8542-85a7937520f1"), Название = "Лес" }
                    );
                });
